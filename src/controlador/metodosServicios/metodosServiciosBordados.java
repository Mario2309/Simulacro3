...
public class metodosServiciosBordados {
    ...
    public static void compraServicioBordado(Cliente cliente, Supermercado supermercado){
        String nombreEmpleado = "", areaEmpleado = "";
        Servicio servicio = listaServiciosBordado(supermercado);
        System.out.println(Texto.opinionServicioBordado);
    ...
    private static Servicio listaServiciosBordado(Supermercado supermercado){
        ArrayList<Servicio> servicios = supermercado.getServicios();
        ArrayList<Servicio> listaServicios = new ArrayList<>();
        for (Servicio servicio : servicios) {
            if (servicio instanceof Bordado) {
