...
public class metodosServiciosProtectoresPantalla {
    ...
    public static void compraServicioProteccionMovil(Cliente cliente, Supermercado supermercado){
        String nombreEmpleado = "", areaEmpleado = "";
        Servicio servicio = listaServiciosProteccionMovil(supermercado);
        System.out.println(Texto.opinionServicioProteccionMovil);
    ...
    private static Servicio listaServiciosProteccionMovil(Supermercado supermercado){
        ArrayList<Servicio> servicios = supermercado.getServicios();
        ArrayList<Servicio> listaServicios = new ArrayList<>();
        for (Servicio servicio : servicios) {
            if (servicio instanceof ProteccionMovil) {
